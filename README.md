...
oc new-app --template=nodejs-istio-tracing-redhat-greeting-service -p SOURCE_REPOSITORY_URL=https://github.com/nodeshift-starters/nodejs-istio-tracing-redhat -p SOURCE_REPOSITORY_REF=8.x -p SOURCE_REPOSITORY_DIR=greeting-service
oc new-app --template=nodejs-istio-tracing-redhat-cute-name-service -p SOURCE_REPOSITORY_URL=https://github.com/nodeshift-starters/nodejs-istio-tracing-redhat -p SOURCE_REPOSITORY_REF=8.x -p SOURCE_REPOSITORY_DIR=cute-name-service
```
